...
export default function DebugBondsPage() {
  ...
  const fetchDebugData = async () => {
    ...
    setError(null)
    try {
      const response = await fetch("/api/debug-bonds")
    ...
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-900">Debug Bonds API</h1>
            <p className="text-slate-600">Diagnóstico de conexión a Google Sheets para Bonds</p>
          </div>
